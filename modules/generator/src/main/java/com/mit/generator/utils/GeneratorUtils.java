...
import com.mit.generator.entity.ColumnEntity;
import com.mit.generator.entity.TableEntity;
...
public class GeneratorUtils {
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        String js = "index.js.vm";
        String vue = "index.vue.vm";
        String biz = "biz.java.vm";
        String mapper = "mapper.java.vm";
        String entity = "entity.java.vm";
        String controller = "controller.java.vm";
        String xml = "mapper.xml.vm";
