package com.mit.community.module.commandManager.handler;

import com.mit.community.module.commandManager.CommandManager;
import com.mit.community.module.commandManager.handler.KeepAliveHandler;
import com.mit.community.module.commandManager.handler.OutHandlerMethod;
...
public class OutHandler extends Thread {
	 ...
	 * @return
	 */
	public static com.mit.community.module.commandManager.handler.OutHandler create(InputStream is, String id, OutHandlerMethod ohm) {
	 ...
	 * @return
	 */
	public static com.mit.community.module.commandManager.handler.OutHandler create(InputStream is, String id, OutHandlerMethod ohm, boolean start) {
		com.mit.community.module.commandManager.handler.OutHandler out= new com.mit.community.module.commandManager.handler.OutHandler(is, id, ohm);
		if(start)
			out.start();
		return out;
	}
