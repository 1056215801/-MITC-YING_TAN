...
import com.mit.community.entity.FlowPeopleInfo;
import com.mit.community.mapper.FlowPeopleMapper;
...
public class FlowPeopleService {
    ...
    public void save(String lryy, String bzlx, String zjhm, LocalDateTime djrq, LocalDateTime zjdqrq, String zslx,
        ...
        FlowPeopleInfo flowPeopleInfo = new FlowPeopleInfo(lryy, bzlx, zjhm, djrq, zjdqrq, zslx, sfzdgzry, tslxfs, jtzycylxfs, yhzgx, hzsfz, person_baseinfo_id);
