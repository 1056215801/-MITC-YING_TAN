...
public class DeviceService {
    ...
    @Autowired
    private AuthorizeAppHouseholdDeviceService authorizeAppHouseholdDeviceService;
    ...
    */
    public List<Device> listByHouseholdIdList(List<Integer> householdIdList){
        List<AuthorizeAppHouseholdDevice> authorizeAppHouseholdDevices = authorizeAppHouseholdDeviceService.listByHouseholdIdList(householdIdList);
