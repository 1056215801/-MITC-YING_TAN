...
import com.mit.community.service.PersonBaseInfoService;
...
public class PersonBaseInfoController {
    ...
    public Result savePersonBaseInfo(String idCardNum, String name, String formerName, String gender, @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDate birthday, String nation, String nativePlace, String matrimony, String politicCountenance,
        ...
        Integer id = personBaseInfoService.save(idCardNum, name, formerName, gender, birthday, nation, nativePlace, matrimony, politicCountenance, education, religion, jobType, profession, cellphone, placeOfDomicile,
                placeOfDomicileDetail, placeOfReside, placeOfResideDetail, placeOfServer, photoBase64);
