...
public class EngPeopleController {
    ...
    public Result save(String wwx, String wwm, String zwm, String gj, String zjxy, String zjdm, String zjhm,
                       @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime zjyxq, String lhmd, @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime ddrq, @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime yjlkrq, @RequestParam( required = false, defaultValue = "0")Integer sfzdry, Integer person_baseinfo_id){
    ...
    public Result update(String wwx, String wwm, String zwm, String gj, String zjxy, String zjdm, String zjhm,
                       @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime zjyxq, String lhmd, @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime ddrq, @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime yjlkrq, @RequestParam( required = false, defaultValue = "0")Integer sfzdry, Integer person_baseinfo_id, int isDelete){
