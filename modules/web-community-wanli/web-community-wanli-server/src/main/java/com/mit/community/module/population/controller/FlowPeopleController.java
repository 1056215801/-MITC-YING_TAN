...
public class FlowPeopleController {
    ...
    public Result save(String lryy, String bzlx, String zjhm,
                       @RequestParam(required = false) String djrq,
                       @RequestParam(required = false) String zjdqrq, String zslx,
                       @RequestParam(required = false, defaultValue = "0") Integer sfzdgzry, String tslxfs, String jtzycylxfs, String yhzgx, String hzsfz, Integer person_baseinfo_id) throws ParseException {
        flowPeopleService.save(lryy, bzlx, zjhm, DateUtils.dateStrToLocalDateTime(djrq),
                DateUtils.dateStrToLocalDateTime(zjdqrq), zslx, sfzdgzry, tslxfs, jtzycylxfs,
                yhzgx, hzsfz, person_baseinfo_id);
