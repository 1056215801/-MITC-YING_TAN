...
import com.mit.community.mapper.data.dao.FireHydrantBlockStatusMapper;
 ...
 */
@Service
public class FireHydrantBlockStatusService extends ServiceImpl<FireHydrantBlockStatusMapper, FireHydrantBlockStatus> {
    @Autowired
    private FireHydrantBlockStatusMapper fireHydrantBlockStatusMapper;
     ...
     * @company mitesofor
     */
    public Page<FireHydrantBlockStatus> listPage(String communityCode, String deviceNum, String devicePlace, Short status,
                                                 Short deviceStatus, LocalDate gmtWarnStart,
                                                 LocalDate gmtUploadEnd, Integer pageNum,
                                                 Integer pageSize) {

        EntityWrapper<FireHydrantBlockStatus> wrapper = new EntityWrapper<>();
    ...
    public void insertDataXJB() {
        ...
        wrapper.orderBy("gmt_upload", false);
        List<FireHydrantBlockStatus> s = fireHydrantBlockStatusMapper.selectPage(new RowBounds(1, 1), wrapper);
...
//        now = now.plusDays(1);
        ...
        while ((localDateTime.isBefore(now))) {
            for (int i = 0; i < deviceNameArray.length; i++) {
                ...
                String deviceNum;
                if (i < 10) {
                    deviceNum = "ytxjb-gm-00" + (i + 1);
                } else if (i < 99) {
                    deviceNum = "ytxjb-gm-0" + (i + 1);
                } else {
                    deviceNum = "ytxjb-gm-" + (i + 1);
                }
                ...
                FireHydrantBlockStatus fireHydrantBlockStatus = new FireHydrantBlockStatus(communityCode, deviceNum,
        ...
        if (!fireHydrantBlockStatuses.isEmpty()) {
            this.insertBatch(fireHydrantBlockStatuses);
        }
    }
...
//        now = now.plusDays(1);
        ...
        while ((localDateTime.isBefore(now))) {
            for (int i = 0; i < deviceNameArray.length; i++) {
                ...
                String deviceNum;
                if (i < 10) {
                    deviceNum = "ytkxwt-gm-00" + (i + 1);
                } else if (i < 99) {
                    deviceNum = "ytkxwt-gm-0" + (i + 1);
                } else {
                    deviceNum = "ytkxwt-gm-" + (i + 1);
                }
                Short deviceStatus = 1;
                if (localDateTime.getYear() == now.getYear() && localDateTime.getMonth() == now.getMonth() && localDateTime.getDayOfMonth() == now.getDayOfMonth()) {
                    int r = RandomUtil.random(1, 100);
...
//        now = now.plusDays(1);
        ...
        while ((localDateTime.isBefore(now))) {
            for (int i = 0; i < deviceNameArray.length; i++) {
                ...
                String deviceNum;
                if (i < 10) {
                    deviceNum = "ytywhdhy-gm-00" + (i + 1);
                } else if (i < 99) {
                    deviceNum = "ytywhdhy-gm-0" + (i + 1);
                } else {
                    deviceNum = "ytywhdhy-gm-" + (i + 1);
                }
                Short deviceStatus = 1;
                if (localDateTime.getYear() == now.getYear() && localDateTime.getMonth() == now.getMonth() && localDateTime.getDayOfMonth() == now.getDayOfMonth()) {
                    int r = RandomUtil.random(1, 100);
...
//        now = now.plusDays(1);
        ...
        while ((localDateTime.isBefore(now))) {
            for (int i = 0; i < deviceNameArray.length; i++) {
                ...
                String deviceNum;
                if (i < 10) {
                    deviceNum = "ytny-gm-00" + (i + 1);
                } else if (i < 99) {
                    deviceNum = "ytny-gm-0" + (i + 1);
                } else {
                    deviceNum = "ytny-gm-" + (i + 1);
                }
                Short deviceStatus = 1;
                if (localDateTime.getYear() == now.getYear() && localDateTime.getMonth() == now.getMonth() && localDateTime.getDayOfMonth() == now.getDayOfMonth()) {
                    int r = RandomUtil.random(1, 100);
